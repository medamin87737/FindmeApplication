...
@Component({
  selector: 'app-inviter-charge-de-recrutement',
  templateUrl: './inviter-charge-de-recrutement.component.html',
  styleUrl: './inviter-charge-de-recrutement.component.scss'
})
export class InviterChargeDeRecrutementComponent implements OnInit {
