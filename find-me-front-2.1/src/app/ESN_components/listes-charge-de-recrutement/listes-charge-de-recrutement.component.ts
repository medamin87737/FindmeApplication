...
@Component({
  selector: 'app-listes-charge-de-recrutement',
  templateUrl: './listes-charge-de-recrutement.component.html',
  styleUrl: './listes-charge-de-recrutement.component.scss'
})
export class ListesChargeDeRecrutementComponent implements OnInit {
